        ...
        <div className='grid md:grid-cols-3 py-5'>
          ...
          <div className='py-8 px-4'>
            ...
            <div className='flex items-center h-10'>
              <input type="text" 
              className='py-1 px-3 w-full h-[100%] inline-block focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500 bg-gray-800 border-gray-200 border-2' placeholder='Email'/>
        ...
        <div className='hidden sm:block'>
          <div className='flex justify-between items-center py-6 border-t-2 border-gray-400'>
            <span className='text-sm text-gray-400'>
              copyright &copy; 2024 by sAyEM
            </span>
            <div className='flex items-center justify-center gap-4 pd-4'>
              <a href="">
